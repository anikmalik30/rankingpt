          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div
                ...
                data-aos-delay="400"
              >
                <h2>Why E-Commerce SEO?
                </h2>

                <p>
                  {" "}
                  We develop customized strategies for each of our clients, ensuring that each store is optimized based on their existing issues and desired goals. Our eCommerce SEO includes optimizing product pages, descriptions, titles, metadata, internal link building, and navigation to improve the user experience.
                </p>
              </div>
            </div>
