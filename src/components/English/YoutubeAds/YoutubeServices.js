...
import ProjectStartImg from "../../../assets/images/ppc/youtubevideos.png"
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-md-12">
              <div
                ...
                data-aos-delay="400"
              >
                <h2>Why YouTube Ads?  </h2>
                <p></p>
                <p>
                  {" "}
                  YouTube is the second largest search engine, with over 2 billion monthly active users. As a result, it's no surprise that YouTube has become a popular platform for advertising. YouTube Ads campaigns can drive desired results quickly at a comparatively low cost.  </p>
