...
const Pricing = () => {
  return (
    <>
      <div className="mibix-pricing-area pt-100 pb-75">
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6">
              <div className="mibix-pricing-card with-style-two">
                ...
                <ul className="pricing-list">
                  <li>
                    <i className="bx bx-check"></i> 10GB Bandwidth Internet
                  </li>
                  <li>
                    <i className="bx bx-check"></i> Business & Financ Analysing
                  </li>
                  <li>
                    <i className="bx bx-check"></i> 25 Social Media Reviews
                  </li>
                  <li>
                    <i className="bx bx-check"></i> Customer Managemet
                  </li>
                  <li>
