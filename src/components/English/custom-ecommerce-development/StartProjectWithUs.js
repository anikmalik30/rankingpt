...
import ProjectStartImg from "../../../assets/images/services/ecommerce.png"
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-12">
              <div 
                ...
                data-aos-delay="400"
              >
                <h2>Benefit from an eCommerce solution by RankingPT</h2>
                <p>
                We are ready to develop the eCommerce solution tailored to your business.
